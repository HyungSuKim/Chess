...
//	턴 종료 버튼
	...
	public GameTimerView() {
		...
		add(new TimerPanel(true), createMatchParentConstraints(3));
		add(new TimerPanel(false), createMatchParentConstraints(3));
...
//	턴종료 버튼을 클릭하면 타이머의 작동 스위치의 상태를 바꿔주어서 시간이 흐르고 안흐르게 하려고 했다.
			...
			public void onClick(Component component) {
				((TimerPanel)getComponent(0)).getTimer().timerOperateSwitch();
				((TimerPanel)getComponent(1)).getTimer().timerOperateSwitch();
			}
