...
// 초기 체스말을 보드위에 셋팅한다.
	public ChessmanSetter(BoardView board) {
		for (ChessmanType type : ChessmanType.values()) {
			setInitChessmanOnBoard(type, board);
		}
	}
//	타입에 맞는 말을 보드의 초기 위치에 셋팅해준다. 
	private void setInitChessmanOnBoard(ChessmanType type, BoardView board) {
		switch (type) {
		case KING:
...
//	초기 킹을 보드위 정해진 위치에 셋팅해준다.
	private void setInitKingOnBoard(ChessmanType type, BoardView board) {
...
//	초기 퀸을 보드위 정해진 위치에 셋팅해준다.
	private void setInitQueenOnBoard(ChessmanType type, BoardView board) {
...
//	초기 비숍을 보드위 정해진 위치에 셋팅해준다.
	private void setInitBishopOnBoard(ChessmanType type, BoardView board) {
...
//	초기 나이트를 보드위 정해진 위치에 셋팅해준다.
	private void setInitKnightOnBoard(ChessmanType type, BoardView board) {
...
//	초기 룩을 보드위 정해진 위치에 셋팅해준다.
	private void setInitRookOnBoard(ChessmanType type, BoardView board) {
...
//	초기 폰을 보드위 정해진 위치에 셋팅해준다.
	private void setInitPawnOnBoard(ChessmanType type, BoardView board) {
