...
//		}
	...
	private FlatPanel createTimerInfoView() {
		...
		timerInfoView.setBackground(theme.getDarkBlueColor());
	...
	private FlatPanel createTimerPanel() {
		...
		timerPanel.setBackground(theme.getDarkBlueColor());
	...
	private FlatLabel createWhiteTimerInfo() {
		...
		whiteTimerInfo.setFont(theme.getBoldFont15Pt());
	...
	private FlatLabel createBlackTimerInfo() {
		...
		blackTimerInfo.setFont(theme.getBoldFont15Pt());
	...
	private FlatLabel createPhaseEndButtonInfo() {
		...
		phaseEndButtonInfo.setFont(theme.getBoldFont15Pt());
	...
	private static FlatLabel createBlackTimerLabel() {
		...
		blackTimerLabel.setBackground(theme.getLightBlueColor());
